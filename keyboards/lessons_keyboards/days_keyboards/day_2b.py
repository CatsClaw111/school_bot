...
but_2b_tue = KeyboardButton(text='Вторник_2Б')
but_2b_wed = KeyboardButton(text='Среда_2Б')
but_2b_thu = KeyboardButton(text='Четверг_2Б')
but_2b_fri = KeyboardButton(text='Пятница_2Б')
