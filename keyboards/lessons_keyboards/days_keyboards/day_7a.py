...
but_7a_tue = KeyboardButton(text='Вторник_7А')
but_7a_wed = KeyboardButton(text='Среда_7А')
but_7a_thu = KeyboardButton(text='Четверг_7А')
but_7a_fri = KeyboardButton(text='Пятница_7А')
