...
but_2v_tue = KeyboardButton(text='Вторник_2В')
but_2v_wed = KeyboardButton(text='Среда_2В')
but_2v_thu = KeyboardButton(text='Четверг_2В')
but_2v_fri = KeyboardButton(text='Пятница_2В')
