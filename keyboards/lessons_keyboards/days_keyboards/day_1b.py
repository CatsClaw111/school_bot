...
but_1b_tue = KeyboardButton(text='Вторник_1Б')
but_1b_wed = KeyboardButton(text='Среда_1Б')
but_1b_thu = KeyboardButton(text='Четверг_1Б')
but_1b_fri = KeyboardButton(text='Пятница_1Б')
