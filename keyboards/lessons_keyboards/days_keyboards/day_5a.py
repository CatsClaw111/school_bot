...
but_5a_tue = KeyboardButton(text='Вторник_5А')
but_5a_wed = KeyboardButton(text='Среда_5А')
but_5a_thu = KeyboardButton(text='Четверг_5А')
but_5a_fri = KeyboardButton(text='Пятница_5А')
