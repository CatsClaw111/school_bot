...
but_6b_tue = KeyboardButton(text='Вторник_6Б')
but_6b_wed = KeyboardButton(text='Среда_6Б')
but_6b_thu = KeyboardButton(text='Четверг_6Б')
but_6b_fri = KeyboardButton(text='Пятница_6Б')
