...
but_2a_tue = KeyboardButton(text='Вторник_2А')
but_2a_wed = KeyboardButton(text='Среда_2А')
but_2a_thu = KeyboardButton(text='Четверг_2А')
but_2a_fri = KeyboardButton(text='Пятница_2А')
