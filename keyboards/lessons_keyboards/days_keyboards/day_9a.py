...
but_9a_tue = KeyboardButton(text='Вторник_9А')
but_9a_wed = KeyboardButton(text='Среда_9А')
but_9a_thu = KeyboardButton(text='Четверг_9А')
but_9a_fri = KeyboardButton(text='Пятница_9А')
