...
but_3e_tue = KeyboardButton(text='Вторник_3Э')
but_3e_wed = KeyboardButton(text='Среда_3Э')
but_3e_thu = KeyboardButton(text='Четверг_3Э')
but_3e_fri = KeyboardButton(text='Пятница_3Э')
