...
but_9v_tue = KeyboardButton(text='Понедельник_9В')
but_9v_wed = KeyboardButton(text='Понедельник_9В')
but_9v_thu = KeyboardButton(text='Понедельник_9В')
but_9v_fri = KeyboardButton(text='Понедельник_9В')

days_9_key = ReplyKeyboardMarkup(
