...
but_10a_tue = KeyboardButton(text='Вторник_10А')
but_10a_wed = KeyboardButton(text='Среда_10А')
but_10a_thu = KeyboardButton(text='Четверг_10А')
but_10a_fri = KeyboardButton(text='Пятница_10А')
