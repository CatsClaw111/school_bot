...
but_7b_tue = KeyboardButton(text='Вторник_7Б')
but_7b_wed = KeyboardButton(text='Среда_7Б')
but_7b_thu = KeyboardButton(text='Четверг_7Б')
but_7b_fri = KeyboardButton(text='Пятница_7Б')
